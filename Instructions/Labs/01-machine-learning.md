...
1. 在您的 Azure Machine Learning 工作區中，選取 **啟動工作室**（或開啟新的瀏覽器索引標籤並瀏覽到 [https://ml.azure.com](https://ml.azure.com?azure-portal=true)，然後使用您的 Microsoft 帳戶登入 Azure Machine Learning 工作室）。 關閉顯示的任何訊息。
